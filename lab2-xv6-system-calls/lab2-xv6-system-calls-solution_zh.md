...
![截屏2026-06-25 23.51.11](./截屏2026-06-255%2023.51.11.png)

![截屏2026-06-25 21.39.14](./截屏2026-06-25%2021.39.14.png)
...
![截屏2026-06-25 21.40.49](./截屏2026-06-25%2021.40.49.png)

继续输入 `layout` 和 `backtrace` 命令后，界面如下：

![截屏2026-06-25 21.41.15](./截屏2026-06-25%2021.41.15.png)

![截屏2026-06-25 21.41.47](./截屏2026-06-25%2021.41.47.png)
...
![截屏2026-06-25 21.44.34](./截屏2026-06-25%2021.44.34.png)

![截屏2026-06-25 21.45.31](./截屏2026-06-25%2021.45.31.png)
...
![截屏2026-06-25 23.52.06](./截屏2026-06-255%2023.52.06.png)
...
![截屏2026-06-25 22.07.57](./截屏2026-06-25%2022.07.57.png)

---

#### Q4: 写出内核发生 panic 时对应的汇编指令。变量 num 对应哪个寄存器？

![截屏2026-06-25 22.11.29](./截屏2026-06-25%2022.11.29.png)
...
![截屏2026-06-25 22.17.30](./截屏2026-06-25%2022.17.30.png)

![截屏2026-06-25 22.17.43](./截屏2026-06-25%2022.17.43.png)

继续执行后，程序如预期停留在该断点处，与 `kernel.asm` 中找到的指令完全吻合——即尝试将地址 `0x0` 的内容加载到寄存器 `a3`：

![截屏2026-06-25 22.28.05](./截屏2026-06-25%2022.28.05.png)
...
![截屏2026-06-25 22.28.27](./截屏2026-06-25%2022.28.27.png)

...
请查阅[实验工具页面](https://pdos.csail.mit.edu/6.1810/2025/labs/tools.html)，了解如何配置计算机以运行本系列实验。
...
本实验及后续实验所需的文件均通过 Git 分发。每个实验对应一个为其定制的 xv6 版本，需切换到相应分支获取。如需了解 Git 的使用，可参阅 [Git 用户手册](http://www.kernel.org/pub/software/scm/git/docs/user-manual.html)或[这份面向 CS 学生的 Git 概览](http://eagain.net/articles/git-for-computer-scientists/)。
